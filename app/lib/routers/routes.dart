...
class Routes {
  ...
  static String myExtensionList = '/myExtensionList';
  ...
  static void configureRoutes(Router router) {
    ...
    router.define(myExtensionList, handler: myExtensionListPageHanderl);
    router.define(myLog, handler: myLogtPageHanderl);
  }
}